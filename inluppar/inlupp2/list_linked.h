...
/// @return an empty linked list with a first, last pointer and size
...
/// @param value the value to be appended
/// @return pointer to the new link or NULL if not inserted
...
///  successful or not and the value removed 
...
/// @param list the linked list that will be extended
/// @param index the position in the list
/// @return option with true or false depending if get was successful 
///  or not and the value at the given position
