...
/// @param iter the iterator
/// @return option with true or false depending if next was successful 
///  or not and the next element
option_t ioopm_iterator_next(ioopm_list_iterator_t *iter);

/// @brief Remove the current element from the underlying list
/// remove can't be done on empty list
/// @param iter the iterator
...
/// @param iter the iterator
/// @return option with true or false depending if current was successful 
///  or not and the current element
